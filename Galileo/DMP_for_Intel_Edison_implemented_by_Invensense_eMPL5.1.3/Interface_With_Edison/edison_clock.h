 ...
 */
/******************************************************************************
 * $Id: msp430_sysclock.h $ //qq95538 intel edison version edison_clock.h
 *****************************************************************************/
/**
 ...
 *
 *  @{
 *      @file       msp430_clock.h //qq95538 intel edison version edison_clock.h
 ...
 */
#ifndef _EDISON_CLOCK_H_
#define _EDISON_CLOCK_H_
//qq95538 I only remain get clock and delay functions and rewrite them as inline functions.
 ...
 *  @return      0 if successful.
 */
inline int edison_get_clock_ms(unsigned long *count);
/**
