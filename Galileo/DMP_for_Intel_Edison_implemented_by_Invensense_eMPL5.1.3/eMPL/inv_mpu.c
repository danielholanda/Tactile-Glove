...
#include <math.h>
#include "inv_mpu.h"
#include "../Interface_With_Edison/edison_setting.h" //q95538
 ...
 * min(int a, int b)
 */
//An Intel Edison Presentation by qq95538
...
#elif defined EMPL_TARGET_EDISON
/* Intel Edison version.
 */
#include "../Interface_With_Edison/edison_setting.h"
#include "../Interface_With_Edison/edison_i2c.h"
#include "../Interface_With_Edison/edison_clock.h"
#define i2c_write   edison_i2c_write
#define i2c_read    edison_i2c_read
#define delay_ms    edison_delay_ms
#define get_ms      edison_get_clock_ms
#define min(a,b) ((a<b)?a:b)
static inline int reg_int_cb(struct int_param_s *int_param)
{
    mraa_gpio_isr(int_param->gpio_context_of_pin, MRAA_GPIO_EDGE_RISING, int_param->cb, int_param->args);//qq95538
    return 0;
}
#define log_i       printf
#define log_e       printf
// Is Edison defined labs or fabs?
//#define labs        abs
//#define fabs(x)     (((x)>0)?(x):-(x))
#else
